...
description: Decompilation can produce very low quality C code in an attempt to get a 100% match. This code can often be improved without compromising the match. This skill will clean up C functions to produce more idiomatic code. Use this skill when asked to clean up C functions.
---
...
Look at the function. Think about what its purpose is in the broader project and how it relates to other functions (as a caller / callee).
