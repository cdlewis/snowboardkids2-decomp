...
- `python3 tools/score_functions.py --min-score 100 --max-score 200 <directory>` find the easiest function to decompile in a given directory (and its subdirectories).
...
1. Use `python3 tools/score_functions.py --min-score 100 --max-score 200 asm/nonmatchings/` tool to find the easiest function. Start with that one.
