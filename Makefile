...
FORMAT_H_FILES = $(filter-out include/hasm.h include/common.h include/include_asm.h,$(H_FILES))
...
LINKER_SCRIPTS := linker_scripts/hardware_regs.ld linker_scripts/libultra_syms.ld linker_scripts/data_field_syms.ld linker_scripts/game_syms.ld
...
MODELPAYLOAD_SOURCES := $(filter-out $(MODELPAYLOAD_ASSET_SIZE_HEADER),$(shell find assets/modelpayload -type f 2>/dev/null))
