...
typedef struct {
    s16 unk0;
    s16 unk2;
} func_800B0A04_1DDAB4_arg0;
typedef struct {
    u8 padding[0xC];
    s32 unkC;
} func_800B0A04_1DDAB4_arg1;
...
typedef struct {
    ...
    s32 unk8;
    s32 unkC;
} func_800B08D0_1DD980_arg0;
typedef struct {
    u8 padding[0xC];
    s32 unkC;
} func_800B08D0_1DD980_arg1;
typedef struct {
    s16 unk0;
    s16 unk2;
    s32 unk4;
    ...
    s16 unkC;
    s32 unk10;
} func_800B0920_1DD9D0_arg0;
typedef struct {
    u8 padding[0xC];
    s32 unkC;
} func_800B0920_1DD9D0_arg1;
