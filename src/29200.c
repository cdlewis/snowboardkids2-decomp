...
u16 gNpcAnimIndicesGroup1[] = { 0x000D, 0x000E, 0x000F, 0xFFFF };
u16 gNpcAnimIndicesGroup2[] = { 0x000A, 0x000B, 0x000C, 0xFFFF };
u16 gNpcAnimIndicesGroup3[] = { 0x0014, 0x0015, 0x0016, 0xFFFF };
u16 gNpcAnimIndicesGroup4[] = { 0x0016, 0x0017, 0x0018, 0xFFFF };
u16 gNpcAnimIndicesGroup5[] = { 0x0011, 0x0012, 0x0013, 0xFFFF };

s32 gStoryMapNpcAnimConfig[] = { 0x0000FFFF,
                                 0x001B001B,
                                 0xFFFF0000,
                                 0x00000000,
                                 (s32)gNpcAnimIndicesGroup1,
                                 (s32)gNpcAnimIndicesGroup1,
                                 (s32)gNpcAnimIndicesGroup4,
                                 (s32)gNpcAnimIndicesGroup1,
                                 (s32)gNpcAnimIndicesGroup1,
                                 (s32)gNpcAnimIndicesGroup2,
                                 (s32)gNpcAnimIndicesGroup1,
                                 0x00000000,
                                 (s32)gNpcAnimIndicesGroup1,
                                 (s32)gNpcAnimIndicesGroup1,
...
void initStoryMapItem(StoryMapItem *arg0) {
    ...
    alloc->unk418 = gStoryMapItemConfig[arg0->eventTypeIndex];
