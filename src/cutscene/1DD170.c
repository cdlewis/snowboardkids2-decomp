...
struct {
    ...
    "               ",
    {
        ...
        { "CHRBK \0", '\1', "CHR BACK       \0", (void *)&cutsceneChrMoveToFacing_init,      (void *)&cutsceneChrMoveToFacing_validate,      (void *)&cutsceneChrMoveToFacing_exec,      NULL,                                (void *)&cutsceneChrMoveToFacing_isDone      },
        ...
        { "SEP   \0", '\1', "SE PLAY        \0", (void *)&cutsceneSePlay_init,       (void *)&cutsceneSePlay_validate,       (void *)&cutsceneSePlay_exec,       NULL,                                NULL                                 },
        { "SEP3D \0", '\1', "SE3D PLAY      \0", (void *)&cutsceneSe3dPlay_init,     (void *)&cutsceneSe3dPlay_validate,     (void *)&cutsceneSe3dPlay_exec,     NULL,                                NULL                                 },
        { "SEST  \0", '\1', "SE STOP        \0", (void *)&cutsceneSeStop_init,       (void *)&cutsceneSeStop_validate,       (void *)&cutsceneSeStop_exec,       NULL,                                NULL                                 },
...
s32 initializeSlotState(StateEntry *state, CutsceneManager *cutsceneManager, s8 index) {
    s32 didRun;
    CommandEntry *commandEntry;
    CutsceneSlot *activeSlot;
    s32 shouldExecute;
    ...
    if (commandEntry->exec != NULL) {
        ...
        if (shouldExecute) {
            commandEntry->exec(state, cutsceneManager, index);
        }
