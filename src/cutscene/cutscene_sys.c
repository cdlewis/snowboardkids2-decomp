...
CutsceneFrameInfo D_800BA5D0_1E7680[1] = {
    { &CUTSCENE_SUNNY_MOUNTAIN_INTRO_FRAME_0_ROM_START, &CUTSCENE_SUNNY_MOUNTAIN_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA5DC_1E768C[1] = {
    { &CUTSCENE_SUNNY_MOUNTAIN_WIN_FRAME_0_ROM_START, &CUTSCENE_SUNNY_MOUNTAIN_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA5E8_1E7698[1] = {
    { &CUTSCENE_TURTLE_ISLAND_INTRO_FRAME_0_ROM_START, &CUTSCENE_TURTLE_ISLAND_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA5F4_1E76A4[1] = {
    { &CUTSCENE_TURTLE_ISLAND_WIN_FRAME_0_ROM_START, &CUTSCENE_TURTLE_ISLAND_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA600_1E76B0[1] = {
    { &CUTSCENE_JINGLE_TOWN_INTRO_FRAME_0_ROM_START, &CUTSCENE_JINGLE_TOWN_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA60C_1E76BC[1] = {
    { &CUTSCENE_JINGLE_TOWN_WIN_FRAME_0_ROM_START, &CUTSCENE_JINGLE_TOWN_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA618_1E76C8[1] = {
    { &CUTSCENE_JINGLE_TOWN_BOSS_WIN_FRAME_0_ROM_START, &CUTSCENE_JINGLE_TOWN_BOSS_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA624_1E76D4[4] = {
    { &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_0_ROM_START, &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_0_ROM_END, 0x78E0 },
    { &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_1_ROM_START, &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_1_ROM_END, 0x78E0 },
    { &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_2_ROM_START, &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_2_ROM_END, 0x78E0 },
    { &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_3_ROM_START, &CUTSCENE_CRAZY_JUNGLE_INTRO_FRAME_3_ROM_END, 0x78E0 },
};
CutsceneFrameInfo D_800BA654_1E7704[1] = {
    { &CUTSCENE_CRAZY_JUNGLE_WIN_FRAME_0_ROM_START, &CUTSCENE_CRAZY_JUNGLE_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA660_1E7710[1] = {
    { &CUTSCENE_CRAZY_JUNGLE_BOSS_WIN_FRAME_0_ROM_START, &CUTSCENE_CRAZY_JUNGLE_BOSS_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA66C_1E771C[1] = {
    { &CUTSCENE_WENDYS_HOUSE_INTRO_FRAME_0_ROM_START, &CUTSCENE_WENDYS_HOUSE_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA678_1E7728[1] = {
    { &CUTSCENE_WENDYS_HOUSE_WIN_FRAME_0_ROM_START, &CUTSCENE_WENDYS_HOUSE_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA684_1E7734[1] = {
    { &CUTSCENE_LINDAS_CASTLE_INTRO_FRAME_0_ROM_START, &CUTSCENE_LINDAS_CASTLE_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA690_1E7740[1] = {
    { &CUTSCENE_LINDAS_CASTLE_WIN_FRAME_0_ROM_START, &CUTSCENE_LINDAS_CASTLE_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA69C_1E774C[1] = {
    { &CUTSCENE_HAUNTED_HOUSE_INTRO_FRAME_0_ROM_START, &CUTSCENE_HAUNTED_HOUSE_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6A8_1E7758[1] = {
    { &CUTSCENE_HAUNTED_HOUSE_WIN_FRAME_0_ROM_START, &CUTSCENE_HAUNTED_HOUSE_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6B4_1E7764[2] = {
    { &CUTSCENE_STARLIGHT_HIGHWAY_INTRO_FRAME_0_ROM_START, &CUTSCENE_STARLIGHT_HIGHWAY_INTRO_FRAME_0_ROM_END, 0x78E0 },
    { &CUTSCENE_STARLIGHT_HIGHWAY_INTRO_FRAME_1_ROM_START, &CUTSCENE_STARLIGHT_HIGHWAY_INTRO_FRAME_1_ROM_END, 0x78E0 },
};
CutsceneFrameInfo D_800BA6CC_1E777C[1] = {
    { &CUTSCENE_STARLIGHT_HIGHWAY_WIN_FRAME_0_ROM_START, &CUTSCENE_STARLIGHT_HIGHWAY_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6D8_1E7788[1] = {
    { &CUTSCENE_ICE_LAND_INTRO_FRAME_0_ROM_START, &CUTSCENE_ICE_LAND_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6E4_1E7794[1] = {
    { &CUTSCENE_ICE_LAND_WIN_FRAME_0_ROM_START, &CUTSCENE_ICE_LAND_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6F0_1E77A0[1] = {
    { &CUTSCENE_ICE_LAND_BOSS_WIN_FRAME_0_ROM_START, &CUTSCENE_ICE_LAND_BOSS_WIN_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA6FC_1E77AC[1] = {
    { &CUTSCENE_SNOWBOARD_STREET_SPEED_CROSS_INTRO_FRAME_0_ROM_START,
     &CUTSCENE_SNOWBOARD_STREET_SPEED_CROSS_INTRO_FRAME_0_ROM_END,
     0x78E0 }
};
CutsceneFrameInfo D_800BA708_1E77B8[1] = {
    { &CUTSCENE_SNOWBOARD_STREET_SHOT_CROSS_INTRO_FRAME_0_ROM_START,
     &CUTSCENE_SNOWBOARD_STREET_SHOT_CROSS_INTRO_FRAME_0_ROM_END,
     0x78E0 }
};
CutsceneFrameInfo D_800BA714_1E77C4[1] = {
    { &CUTSCENE_X_CROSS_INTRO_FRAME_0_ROM_START, &CUTSCENE_X_CROSS_INTRO_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA720_1E77D0[3] = {
    { &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_0_ROM_START, &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_0_ROM_END, 0x78E0 },
    { &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_1_ROM_START, &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_1_ROM_END, 0x78E0 },
    { &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_2_ROM_START, &CUTSCENE_SUNNY_MOUNTAIN_LOSE_FRAME_2_ROM_END, 0x78E0 },
};
CutsceneFrameInfo D_800BA744_1E77F4[1] = {
    { &CUTSCENE_TURTLE_ISLAND_LOSE_FRAME_0_ROM_START, &CUTSCENE_TURTLE_ISLAND_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA750_1E7800[1] = {
    { &CUTSCENE_JINGLE_TOWN_LOSE_FRAME_0_ROM_START, &CUTSCENE_JINGLE_TOWN_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA75C_1E780C[1] = {
    { &CUTSCENE_JINGLE_TOWN_BOSS_LOSE_FRAME_0_ROM_START, &CUTSCENE_JINGLE_TOWN_BOSS_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA768_1E7818[1] = {
    { &CUTSCENE_WENDYS_HOUSE_LOSE_FRAME_0_ROM_START, &CUTSCENE_WENDYS_HOUSE_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA774_1E7824[1] = {
    { &CUTSCENE_LINDAS_CASTLE_LOSE_FRAME_0_ROM_START, &CUTSCENE_LINDAS_CASTLE_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA780_1E7830[1] = {
    { &CUTSCENE_CRAZY_JUNGLE_LOSE_FRAME_0_ROM_START, &CUTSCENE_CRAZY_JUNGLE_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA78C_1E783C[1] = {
    { &CUTSCENE_CRAZY_JUNGLE_BOSS_LOSE_FRAME_0_ROM_START, &CUTSCENE_CRAZY_JUNGLE_BOSS_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA798_1E7848[1] = {
    { &CUTSCENE_STARLIGHT_HIGHWAY_LOSE_FRAME_0_ROM_START, &CUTSCENE_STARLIGHT_HIGHWAY_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA7A4_1E7854[1] = {
    { &CUTSCENE_HAUNTED_HOUSE_LOSE_FRAME_0_ROM_START, &CUTSCENE_HAUNTED_HOUSE_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
CutsceneFrameInfo D_800BA7B0_1E7860[1] = {
    { &CUTSCENE_ICE_LAND_LOSE_FRAME_0_ROM_START, &CUTSCENE_ICE_LAND_LOSE_FRAME_0_ROM_END, 0x78E0 }
};
...
CutsceneFadeAssetNode gCutsceneFadeAssetTable[16] = {
    { &CUTSCENE_FADE_SUNNY_MOUNTAIN_ROM_START,               &CUTSCENE_FADE_SUNNY_MOUNTAIN_ROM_END,    0x36B8, 0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_TURTLE_ISLAND_ROM_START,                &CUTSCENE_FADE_TURTLE_ISLAND_ROM_END,     0x3CC8, 1, { 0, 0, 0 } },
    { &CUTSCENE_FADE_JINGLE_TOWN_ROM_START,                  &CUTSCENE_FADE_JINGLE_TOWN_ROM_END,       0x36B8, 0, { 0, 0, 0 } },
    { NULL,                                                  NULL,                                     0,      0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_WENDYS_HOUSE_ROM_START,                 &CUTSCENE_FADE_WENDYS_HOUSE_ROM_END,      0x3CC8, 1, { 0, 0, 0 } },
    { &CUTSCENE_FADE_LINDAS_CASTLE_ROM_START,                &CUTSCENE_FADE_LINDAS_CASTLE_ROM_END,     0x36B8, 0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_CRAZY_JUNGLE_ROM_START,                 &CUTSCENE_FADE_CRAZY_JUNGLE_ROM_END,      0x3CC8, 1, { 0, 0, 0 } },
    { NULL,                                                  NULL,                                     0,      0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_STARLIGHT_HIGHWAY_ROM_START,            &CUTSCENE_FADE_STARLIGHT_HIGHWAY_ROM_END, 0x36B8, 0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_HAUNTED_HOUSE_ROM_START,                &CUTSCENE_FADE_HAUNTED_HOUSE_ROM_END,     0x36B8, 0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_ICE_LAND_ROM_START,                     &CUTSCENE_FADE_ICE_LAND_ROM_END,          0x36B8, 0, { 0, 0, 0 } },
    { NULL,                                                  NULL,                                     0,      0, { 0, 0, 0 } },
    { &CUTSCENE_FADE_SNOWBOARD_STREET_SPEED_CROSS_ROM_START,
     &CUTSCENE_FADE_SNOWBOARD_STREET_SPEED_CROSS_ROM_END,
     0x36B8,                                                                                                   0,
     { 0, 0, 0 }                                                                                                              },
    { &CUTSCENE_FADE_SNOWBOARD_STREET_SHOT_CROSS_ROM_START,
     &CUTSCENE_FADE_SNOWBOARD_STREET_SHOT_CROSS_ROM_END,
     0x36B8,                                                                                                   0,
     { 0, 0, 0 }                                                                                                              },
    { &CUTSCENE_FADE_X_CROSS_ROM_START,                      &CUTSCENE_FADE_X_CROSS_ROM_END,           0x3CC8, 1, { 0, 0, 0 } },
    { NULL,                                                  NULL,                                     0,      0, { 0, 0, 0 } },
};
