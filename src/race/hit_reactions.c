...
u16 gCharacterVoiceSounds1[] = { 0x0058, 0x0071, 0x0087, 0x009F, 0x00B8, 0x00CD, 0x0108, 0x00F9, 0x00E7, 0x0000 };
u16 gCharacterVoiceSounds2[] = { 0x0059, 0x0072, 0x0088, 0x00A0, 0x00B9, 0x00CE, 0x0109, 0x00FA, 0x00E8, 0x0000 };
u16 gCharacterVoiceSounds3[] = { 0x005A, 0x0073, 0x0089, 0x00A1, 0x00BA, 0x00CF, 0x010A, 0x00FB, 0x00E9, 0x0000 };
