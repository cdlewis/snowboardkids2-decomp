...
void setupGoldCoinEntries(GoldCoinSetupState *arg0) {
    ...
    if (arg0->coinCount > 0) {
        one = 1;
        globalBuf = (s32 *)&gScaleMatrix.translation;
        do {
            offset = i * 16;
...
void initPanelProjectileMovement(PanelProjectileState *arg0) {
    ...
    memcpy(temp_s1, &player->boneResults[12].transform.translation, sizeof(Vec3i));
