...
/* D_800BADE1 and D_800BADE2 are offsets into gAIPlayerParams, referenced by hit_reactions asm */
__asm__(".globl D_800BADE1");
__asm__("D_800BADE1 = gAIPlayerParams + 1");
__asm__(".globl D_800BADE2");
__asm__("D_800BADE2 = gAIPlayerParams + 2");
...
void updateRacePlayer(Player *player) {
    ...
    if (player->inputDisabled != 0) {
        player->maxSpeedCap -= gAIPlayerParams[player->speedPenaltyIndex * 0x44] * 0x202;
    }
