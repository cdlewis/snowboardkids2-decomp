...
/* D_800BADE1 and D_800BADE2 are offsets into D_800BADE0_AAC90, referenced by hit_reactions asm */
__asm__(".globl D_800BADE1");
__asm__("D_800BADE1 = D_800BADE0_AAC90 + 1");
__asm__(".globl D_800BADE2");
__asm__("D_800BADE2 = D_800BADE0_AAC90 + 2");
...
void updateRacePlayer(Player *player) {
    ...
    if (player->inputDisabled != 0) {
        player->maxSpeedCap -= D_800BADE0_AAC90[player->speedPenaltyIndex * 0x44] * 0x202;
    }
