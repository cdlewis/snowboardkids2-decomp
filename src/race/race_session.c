...
USE_OVERLAY(levels_wendys_house);
USE_OVERLAY(levels_lindas_castle);
USE_OVERLAY(levels_crazy_jungle);
USE_OVERLAY(levels_crazy_jungle_boss);
USE_OVERLAY(levels_snowboard_street_shoot_cross);
USE_OVERLAY(levels_starlight_highway);
USE_OVERLAY(levels_haunted_house);
USE_OVERLAY(levels_ice_land_boss);
USE_OVERLAY(levels_ice_land);
USE_OVERLAY(levels_snowboard_street_speed_cross);
...
OverlayEntry Overlays[16] = {
    { .romStart = (void *)&levels_sunny_mountain_ROM_START,
     .romEnd = (void *)&levels_sunny_mountain_ROM_END,
     .ramStart = &levels_sunny_mountain_VRAM,
     .icacheStart = &levels_sunny_mountain_TEXT_START,
     .icacheEnd = &levels_sunny_mountain_TEXT_END,
     .dcacheStart = &levels_sunny_mountain_DATA_START,
     .dcacheEnd = &levels_sunny_mountain_RODATA_END,
     .bssStart = &levels_sunny_mountain_BSS_START,
     .bssEnd = &levels_sunny_mountain_BSS_END },
    { 0 },
    { .romStart = (void *)&levels_jingle_town_ROM_START,
     .romEnd = (void *)&levels_jingle_town_ROM_END,
     .ramStart = &levels_jingle_town_VRAM,
     .icacheStart = &levels_jingle_town_TEXT_START,
     .icacheEnd = &levels_jingle_town_TEXT_END,
     .dcacheStart = &levels_jingle_town_DATA_START,
     .dcacheEnd = &levels_jingle_town_DATA_END,
     .bssStart = &levels_jingle_town_BSS_START,
     .bssEnd = &levels_jingle_town_BSS_END },
    { .romStart = (void *)&levels_jingle_town_boss_ROM_START,
     .romEnd = (void *)&levels_jingle_town_boss_ROM_END,
     .ramStart = &levels_jingle_town_boss_VRAM,
     .icacheStart = &levels_jingle_town_boss_TEXT_START,
     .icacheEnd = &levels_jingle_town_boss_TEXT_END,
     .dcacheStart = &levels_jingle_town_boss_DATA_START,
     .dcacheEnd = &levels_jingle_town_boss_RODATA_END,
     .bssStart = &levels_jingle_town_boss_BSS_START,
     .bssEnd = &levels_jingle_town_boss_BSS_END },
    { .romStart = (void *)&levels_wendys_house_ROM_START,
     .romEnd = (void *)&levels_wendys_house_ROM_END,
     .ramStart = &levels_wendys_house_VRAM,
     .icacheStart = &levels_wendys_house_TEXT_START,
     .icacheEnd = &levels_wendys_house_TEXT_END,
     .dcacheStart = &levels_wendys_house_DATA_START,
     .dcacheEnd = &levels_wendys_house_DATA_END,
     .bssStart = &levels_wendys_house_BSS_START,
     .bssEnd = &levels_wendys_house_BSS_END },
    { .romStart = &levels_lindas_castle_ROM_START,
     .romEnd = (void *)&levels_lindas_castle_ROM_END,
     .ramStart = &levels_lindas_castle_VRAM,
     .icacheStart = &levels_lindas_castle_TEXT_START,
     .icacheEnd = &levels_lindas_castle_TEXT_END,
     .dcacheStart = &levels_lindas_castle_DATA_START,
     .dcacheEnd = &levels_lindas_castle_DATA_END,
     .bssStart = &levels_lindas_castle_BSS_START,
     .bssEnd = &levels_lindas_castle_BSS_END },
    { .romStart = (void *)&levels_crazy_jungle_ROM_START,
     .romEnd = (void *)&levels_crazy_jungle_ROM_END,
     .ramStart = &levels_crazy_jungle_VRAM,
     .icacheStart = &levels_crazy_jungle_TEXT_START,
     .icacheEnd = &levels_crazy_jungle_TEXT_END,
     .dcacheStart = &levels_crazy_jungle_DATA_START,
     .dcacheEnd = &levels_crazy_jungle_DATA_END,
     .bssStart = &levels_crazy_jungle_BSS_START,
     .bssEnd = &levels_crazy_jungle_BSS_END },
    { .romStart = (void *)&levels_crazy_jungle_boss_ROM_START,
     .romEnd = (void *)&levels_crazy_jungle_boss_ROM_END,
     .ramStart = &levels_crazy_jungle_boss_VRAM,
     .icacheStart = &levels_crazy_jungle_boss_TEXT_START,
     .icacheEnd = &levels_crazy_jungle_boss_TEXT_END,
     .dcacheStart = &levels_crazy_jungle_boss_DATA_START,
     .dcacheEnd = &levels_crazy_jungle_boss_DATA_END,
     .bssStart = &levels_crazy_jungle_boss_BSS_START,
     .bssEnd = &levels_crazy_jungle_boss_BSS_END },
    { .romStart = (void *)&levels_starlight_highway_ROM_START,
     .romEnd = (void *)&levels_starlight_highway_ROM_END,
     .ramStart = &levels_starlight_highway_VRAM,
     .icacheStart = &levels_starlight_highway_TEXT_START,
     .icacheEnd = &levels_starlight_highway_TEXT_END,
     .dcacheStart = &levels_starlight_highway_DATA_START,
     .dcacheEnd = &levels_starlight_highway_RODATA_END,
     .bssStart = &levels_starlight_highway_BSS_START,
     .bssEnd = &levels_starlight_highway_BSS_END },
    { .romStart = (void *)&levels_haunted_house_ROM_START,
     .romEnd = (void *)&levels_haunted_house_ROM_END,
     .ramStart = &levels_haunted_house_VRAM,
     .icacheStart = &levels_haunted_house_TEXT_START,
     .icacheEnd = &levels_haunted_house_TEXT_END,
     .dcacheStart = &levels_haunted_house_DATA_START,
     .dcacheEnd = &levels_haunted_house_DATA_END,
     .bssStart = &levels_haunted_house_BSS_START,
     .bssEnd = &levels_haunted_house_BSS_END },
    { .romStart = (void *)&levels_ice_land_ROM_START,
     .romEnd = (void *)&levels_ice_land_ROM_END,
     .ramStart = &levels_ice_land_VRAM,
     .icacheStart = &levels_ice_land_TEXT_START,
     .icacheEnd = &levels_ice_land_TEXT_END,
     .dcacheStart = &levels_ice_land_DATA_START,
     .dcacheEnd = &levels_ice_land_DATA_END,
     .bssStart = &levels_ice_land_BSS_START,
     .bssEnd = &levels_ice_land_BSS_END },
    { .romStart = &levels_ice_land_boss_ROM_START,
     .romEnd = (void *)&levels_ice_land_boss_ROM_END,
     .ramStart = &levels_ice_land_boss_VRAM,
     .icacheStart = &levels_ice_land_boss_TEXT_START,
     .icacheEnd = &levels_ice_land_boss_TEXT_END,
     .dcacheStart = &levels_ice_land_boss_DATA_START,
     .dcacheEnd = &levels_ice_land_boss_DATA_END,
     .bssStart = &levels_ice_land_boss_BSS_START,
     .bssEnd = &levels_ice_land_boss_BSS_END },
    { .romStart = (void *)&levels_snowboard_street_speed_cross_ROM_START,
     .romEnd = (void *)&levels_snowboard_street_speed_cross_ROM_END,
     .ramStart = &levels_snowboard_street_speed_cross_VRAM,
     .icacheStart = &levels_snowboard_street_speed_cross_TEXT_START,
     .icacheEnd = &levels_snowboard_street_speed_cross_TEXT_END,
     .dcacheStart = &levels_snowboard_street_speed_cross_DATA_START,
     .dcacheEnd = &levels_snowboard_street_speed_cross_DATA_END,
     .bssStart = &levels_snowboard_street_speed_cross_BSS_START,
     .bssEnd = &levels_snowboard_street_speed_cross_BSS_END },
    { .romStart = (void *)&levels_snowboard_street_shoot_cross_ROM_START,
     .romEnd = (void *)&levels_snowboard_street_shoot_cross_ROM_END,
     .ramStart = &levels_snowboard_street_shoot_cross_VRAM,
     .icacheStart = &levels_snowboard_street_shoot_cross_TEXT_START,
     .icacheEnd = &levels_snowboard_street_shoot_cross_TEXT_END,
     .dcacheStart = &levels_snowboard_street_shoot_cross_DATA_START,
     .dcacheEnd = &levels_snowboard_street_shoot_cross_DATA_END,
     .bssStart = &levels_snowboard_street_shoot_cross_BSS_START,
     .bssEnd = &levels_snowboard_street_shoot_cross_BSS_END },
    { 0 },
    { .romStart = (void *)&levels_training_ROM_START,
     .romEnd = (void *)&levels_training_ROM_END,
     .ramStart = &levels_training_VRAM,
     .icacheStart = &levels_training_TEXT_START,
     .icacheEnd = &levels_training_TEXT_END,
     .dcacheStart = &levels_training_DATA_START,
     .dcacheEnd = &levels_training_RODATA_END,
     .bssStart = &levels_training_BSS_START,
     .bssEnd = &levels_training_BSS_END },
};
...
void initRace(void) {
    ...
    for (i = 0; i < raceState->totalRacers; i++) {
        ...
        for (j = sizeof(Player) - 1; j >= 0; j--) {
            racerBytes[j] = 0;
        }

        raceState->racers[i].playerIndex = i;
    ...
    switch (gGameSessionContext->gameMode) {
        case GAME_MODE_STORY:
            switch (raceState->currentLevel) {
                case CRAZY_JUNGLE_BOSS:
                    raceState->racers[1].flyingAttackState = 1;
                    raceState->racers[1].characterId = 9;
                    break;
                case JINGLE_TOWN_BOSS:
                    raceState->racers[1].flyingAttackState = 2;
                    raceState->racers[1].characterId = 10;
                    break;
                case ICE_LAND_BOSS:
                    raceState->racers[1].flyingAttackState = 3;
