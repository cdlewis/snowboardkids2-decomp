...
u8 paintShopLocationMarkerText[24] = { _("Paint Shop") };

u8 wendysInternetLocationMarkerText[36] = { _("Wendy`s\n{0xA012}nternet") };

u8 shootCrossLocationMarkerText[24] = { _("Shoot Cross") };

u8 characterSelectLocationMarkerText[36] = { _("Character\nSelect") };

u8 boardShopLocationMarkerText[24] = { _("Board Shop") };

u8 trickGameLocationMarkerText[24] = { _("Trick Game") };

u8 saveAndExitLocationMarkerText[24] = { _("Save & Exit") };

u8 D_8008F940_90540[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF
};

u8 speedCrossLocationMarkerText[24] = { _("Speed Cross") };
...
void *storyMapLocationMarkerTexts[] = { paintShopLocationMarkerText,
                                        wendysInternetLocationMarkerText,
                                        shootCrossLocationMarkerText,
                                        characterSelectLocationMarkerText,
                                        boardShopLocationMarkerText,
                                        trickGameLocationMarkerText,
                                        saveAndExitLocationMarkerText,
                                        D_8008F940_90540,
                                        speedCrossLocationMarkerText,
                                        D_8008F968_90568,
                                        D_8008F978_90578,
                                        D_8008F978_90578,
                                        NULL,
...
void updateStoryMapLocationMarker(StoryMapLocationMarkerState *arg0) {
    ...
    if (arg0->unk72 != 6) {
        ...
        if (arg0->unk64 >= 6) {
            arg0->unk54 = storyMapLocationMarkerTexts[arg0->unk73];
