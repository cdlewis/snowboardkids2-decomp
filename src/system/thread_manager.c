...
static char viThreadStack[0x180];
static OSThread schedThread;
static char schedThreadStack[0x180];
static OSThread displayThread;
static char displayThreadStack[0x180];
static OSThread audioThread;
static char audioThreadStack[0x180];
static OSMesgQueue viEventQueue;
static OSMesg viQueueMsgs[4];
static OSMesgQueue schedQueue;
static OSMesg schedQueueMsgs[8];
static OSMesgQueue audioTaskQueue;
static OSMesg audioTaskQueueMsgs[8];
static OSMesgQueue displayQueue;
static OSMesg displayQueueMsgs[0x20];
static OSMesgQueue dpDoneQueue;
static OSMesg dpDoneQueueMsgs[4];
static OSMesgQueue displaySpDoneQueue;
static OSMesg displaySpDoneQueueMsgs[4];
static OSMesgQueue audioSpDoneQueue;
static OSMesg audioSpDoneQueueMsgs[4];
static OSMesgQueue displayViFrameQueue;
static OSMesg displayViFrameQueueMsgs[1];
static ViConfig *currentViConfig;
static s16 frameCounter;
static s16 bootBlackoutFrames;
