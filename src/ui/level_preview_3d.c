...
extern DisplayLists gCrabDisplayLists;
extern DisplayLists gChestClosedDisplayLists;
extern s32 D_80088630;
extern DisplayLists gPostboxDisplayLists;
extern DisplayLists gPostboxWithNewspaperDisplayLists;
...
ItemAssetEntry itemAssetTable[] = {
    ...
    { &ITEM_DEBRIS_DISPLAY_LIST_ROM_START,
     ...
     0x370, (void *)&gItemDebrisDisplayLists  },
    ...
    { &HAMBURGER_DISPLAY_LIST_ROM_START,
     &HAMBURGER_DISPLAY_LIST_ROM_END,
     &HAMBURGER_COMPRESSED_DATA_ROM_START,
     &HAMBURGER_COMPRESSED_DATA_ROM_END,
     0x620, (void *)&gHamburgerDisplayLists   },
    { &NEWSPAPER_DISPLAY_LIST_ROM_START,
     &NEWSPAPER_DISPLAY_LIST_ROM_END,
     &NEWSPAPER_COMPRESSED_DATA_ROM_START,
     &NEWSPAPER_COMPRESSED_DATA_ROM_END,
     0x620, (void *)&gNewspaperDisplayLists   },
    ...
    { &CRAB_DISPLAY_LIST_ROM_START,
     &CRAB_DISPLAY_LIST_ROM_END,
     &CRAB_COMPRESSED_DATA_ROM_START,
     &CRAB_COMPRESSED_DATA_ROM_END,
     0x770, (void *)&gCrabDisplayLists        },
    ...
    { &CUP_DISPLAY_LIST_ROM_START,
     ...
     0xA90, (void *)&gCupDisplayLists         },
    { &POT_DISPLAY_LIST_ROM_START,
     &POT_DISPLAY_LIST_ROM_END,
     &POT_COMPRESSED_DATA_ROM_START,
     &POT_COMPRESSED_DATA_ROM_END,
     0xA90, (void *)&gPotDisplayLists         },
    { &DISH_DISPLAY_LIST_ROM_START,
     &DISH_DISPLAY_LIST_ROM_END,
     &DISH_COMPRESSED_DATA_ROM_START,
     &DISH_COMPRESSED_DATA_ROM_END,
     0x320, (void *)&gDishDisplayLists        },
    { &CHEST_CLOSED_DISPLAY_LIST_ROM_START,
     &CHEST_CLOSED_DISPLAY_LIST_ROM_END,
     &CHEST_CLOSED_COMPRESSED_DATA_ROM_START,
     &CHEST_CLOSED_COMPRESSED_DATA_ROM_END,
     0x710, (void *)&gChestClosedDisplayLists },
...
ItemAssetEntry DAMIEN_ASSETS[4] = {
    { (void *)&DAMIEN_DISPLAY_LIST_ROM_START,
     (void *)&DAMIEN_DISPLAY_LIST_ROM_END,
     (void *)&DAMIEN_COMPRESSED_DATA_ROM_START,
     (void *)&DAMIEN_COMPRESSED_DATA_ROM_END,
     0x3DE00008, (void *)gDamienSharedModelPartDisplayLists },
    { (void *)&DAMIEN_DISPLAY_LIST_ROM_START,
     (void *)&DAMIEN_DISPLAY_LIST_ROM_END,
     (void *)&DAMIEN_COMPRESSED_DATA_ROM_START,
     (void *)&DAMIEN_COMPRESSED_DATA_ROM_END,
...
AssetGroup gameAssets[] = {
    ...
    {
     .name = " ABOXO ",
     .displayListStart = (void *)&CHEST_OPEN_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&CHEST_OPEN_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " ABOXL ",
     .displayListStart = (void *)&CHEST_CLOSED_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&CHEST_CLOSED_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " KANI  ",
     .displayListStart = (void *)&CRAB_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&CRAB_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " POSP  ",
     .displayListStart = (void *)&POSTBOX_WITH_NEWSPAPER_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&POSTBOX_WITH_NEWSPAPER_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " POST  ",
     .displayListStart = (void *)&POSTBOX_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&POSTBOX_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " NEWS  ",
     .displayListStart = (void *)&NEWSPAPER_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&NEWSPAPER_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " PBOX0 ",
     .displayListStart = (void *)&PRESENT_RED_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&PRESENT_RED_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " PBOX1 ",
     .displayListStart = (void *)&PRESENT_BLUE_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&PRESENT_BLUE_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " USAGI ",
     .displayListStart = (void *)&BUNNY_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&BUNNY_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " HELI  ",
     .displayListStart = (void *)&HELICOPTER_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&HELICOPTER_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " BURG  ",
     .displayListStart = (void *)&HAMBURGER_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&HAMBURGER_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " DOOR  ",
     .displayListStart = (void *)&HAUNTED_HOUSE_DOOR_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&HAUNTED_HOUSE_DOOR_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " LTBL0 ",
     .displayListStart = (void *)&TABLE0_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&TABLE0_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " LTBL1 ",
     .displayListStart = (void *)&TABLE1_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&TABLE1_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " LTBL2 ",
     .displayListStart = (void *)&TABLE2_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&TABLE2_DISPLAY_LIST_ROM_END,
    ...
    {
     .name = " LTBL3 ",
     .displayListStart = (void *)&TABLE3_DISPLAY_LIST_ROM_START,
     .displayListEnd = (void *)&TABLE3_DISPLAY_LIST_ROM_END,
...
void updateModelGeometry(SceneModel *arg0) {
    ...
    DisplayListObject *boneTransform;
    s32 boneCount;
    s32 i;
#else
    register BoneHierarchyEntry *animData __asm__("$17");
    DisplayListObject *boneTransform;
