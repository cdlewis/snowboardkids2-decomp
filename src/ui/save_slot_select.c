...
void initSaveSlotScreen(void) {
    ...
    state->unkAAC = loadCompressedData(&okPromptSprites_ROM_START, &_41AD80_ROM_START, 0x1B48);
    state->unkAB0 = loadCompressedData(&_4547D0_ROM_START, &tiledSnowmanAsset_ROM_START, 0x9488);
